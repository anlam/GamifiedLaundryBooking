...
\def\plainauthor{An Ngoc Lam, An Tran Thien, Susanne Koch Stigberg}
\def\emptyauthor{}
...
%\author{%
  %\alignauthor{An Ngoc Lam\\
    ...
    %\email{anl@hiof.no}}\\
  %\alignauthor{An Tran Thien\\
    %\affaddr{Faculty of Computer Sciences}\\
    %\affaddr{Ostfold University College, Norway}\\
    %\email{antt@hiof.no}}\\
		%\alignauthor{Susanne Koch Stigberg\\
    %\affaddr{Faculty of Computer Sciences}\\
    %\affaddr{Ostfold University College, Norway}\\
    %\email{susanne.k.stigberg@hiof.no}}\\
%}
